...
/** A render error stays inside Delivery: the host, and the other remote, never see it. */
  ...
  override render(): ReactNode {
    ...
    return (
      <div role="alert" style={{ padding: 32, fontFamily: 'var(--bl-font)' }}>
        <h1 style={{ fontSize: 20, margin: '0 0 8px' }}>Delivery hit an error and stopped.</h1>
