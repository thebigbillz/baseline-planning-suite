  ...
  return {
    ...
    module: {
      rules: [
        ...
        { test: /\.module\.css$/, use: ['style-loader', { loader: 'css-loader', options: { modules: { localIdentName: 'dl-[local]-[hash:base64:4]', namedExport: false } } }] },
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({ template: './public/index.html', excludeChunks: ['baseline_delivery'] }),
    ],
    devServer: {
      port: 8082,
      hot: false,
