...
/**
 * Stands in for the shell when People runs on its own. It supplies the same
...
export function Harness() {
  ...
  useEffect(() => {
    ...
    mounted.current = mount(element.current, latest.current);
    return () => {
  ...
  return (
    <div className="harness">
      <div className="harness-bar">
        ...
        <span className="harness-name">people</span>
